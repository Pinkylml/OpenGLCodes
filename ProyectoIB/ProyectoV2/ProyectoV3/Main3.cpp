...
Pixel grid[WINDOW_WIDTH / GRID_SIZE][WINDOW_HEIGHT / GRID_SIZE] = {false}; // Cuadrícula para pintar
...
void keyboard(unsigned char key, int x, int y) {
    ...
    // No es necesario redibujar toda la cuadrícula aquí, solo actualizar el color de dibujo.
